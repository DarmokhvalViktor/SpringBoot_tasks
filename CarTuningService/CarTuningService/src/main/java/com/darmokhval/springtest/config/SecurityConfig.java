...
public class SecurityConfig {
    ...
    @Bean
    public JwtDecoder multiTenancyDecoder() {
        return token -> {
            ...
            System.out.println(decoders.keySet());
            try {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .oauth2ResourceServer(oauth2Customizer -> oauth2Customizer.jwt(jwtConfigurer -> jwtConfigurer.decoder(multiTenancyDecoder())))
                .build();
    }
}
